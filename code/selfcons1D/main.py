...
potential = interpolate(Expression("0"), V)
...
plot(Iv1, title='Electron Density n(x)')

plot(Ie1, title='Wave Function psi1(x)')
plot(Ie2, title='Wave Function psi2(x)')
plot(Ie3, title='Wave Function psi3(x)')

plot(potential, title='V(x)')

plot(phi, title='phi(x)')
